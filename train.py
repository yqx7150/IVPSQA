...
parser.add_argument("--root1", type=str, default="./data/EDose", help="Output images. ")
parser.add_argument("--root2", type=str, default="./data/RTDose", help="Input images. ")
parser.add_argument("--root3", type=str, default="./data/CT", help="Another input images. ")
...
def main(args):
    ...
    for epoch in range(0, 20):
        ...
        for i_batch, sample_batched in enumerate(dataloader):
            ...
            print("task: %s Epoch: %d Step: %d || loss: %.8f rev_loss: %.10f forward_loss: %.8f  || lr: %f time: %f"%(
